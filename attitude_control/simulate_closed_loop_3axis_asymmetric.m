...
% Allow more time because the larger moments of inertia slow the response.
t_final = 60;
...
disp('Inertia-scaled Kp:');
disp(Kp);

disp('Inertia-scaled Kd:');
disp(Kd);
%% Initial six-state vector
% [roll; pitch; yaw; p; q; r]
combined_attitude0 = deg2rad([30; -20; 15]);

initial_state = [combined_attitude0; omega0];
...
grid on;
ylabel('Attitude [deg]');
title('Tuned Asymmetric Three-Axis Attitude Response');
