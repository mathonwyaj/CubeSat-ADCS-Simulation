...
initial_quaternion = ...
    euler_to_quaternion(attitude0);

command_quaternion = ...
    euler_to_quaternion(attitude_cmd);

initial_wheel_speed = [0; 0; 0];% Begin with the x wheel at its positive speed limit.
initial_wheel_speed = [
    wheel_speed_max(1);
    0;
    0
...
grid on;
ylabel('Attitude [deg]');
title('Loss of Roll Authority at Wheel-Speed Saturation');
